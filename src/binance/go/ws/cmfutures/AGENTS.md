...
1. SDK locations: WebSocket SDK at ../../../../../../binance-go/ws/cmfutures and REST SDK at ../../../../../../binance-go/rest/cmfutures. You are only allowed to update the integration tests under the current working directory; you are not allowed to update the SDK code. If you find any SDK issues, please report them first.
