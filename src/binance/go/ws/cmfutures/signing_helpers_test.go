...
func signAndApply(t testing.TB, signer *cmfutures.RequestSigner, authType cmfutures.AuthType, params map[string]interface{}, target interface{}) map[string]interface{} {
	t.Helper()
	if authType == cmfutures.AuthTypeNone {
		return params
	}
	if signer == nil {
