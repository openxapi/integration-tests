...
func signAndApply(t testing.TB, signer *umfutures.RequestSigner, authType umfutures.AuthType, params map[string]interface{}, target interface{}) map[string]interface{} {
	t.Helper()
	if authType == umfutures.AuthTypeNone {
		return params
	}
	if signer == nil {
...
func extractInt64(v interface{}) int64 {
	...
	case fmt.Stringer:
		if parsed, err := strconv.ParseInt(x.String(), 10, 64); err == nil {
			return parsed
		}
	}
	return 0
