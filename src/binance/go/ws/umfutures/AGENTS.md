...
1. SDK locations: WebSocket SDK at ../../../../../../binance-go/ws/umfutures and REST SDK at ../../../../../../binance-go/rest/umfutures. You are only allowed to update the integration tests under the current working directory; you are not allowed to update the SDK code. If you find any SDK issues, please report them first.

2. You should read the SDK code first, learn what can be done using the SDK, write down all the exported interfaces provided by the SDK in @API_COVERAGE.md
