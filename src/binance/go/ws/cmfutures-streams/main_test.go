...
func printTestSummary() {
    ...
    fmt.Printf("  - UserDataStreamChannel → TestFullIntegrationSuite_UserData (auth)\n")
    ...
    fmt.Printf("\n⚠️  Notes:\n")
    fmt.Printf("  - Tests select WS server 'testnet' by default\n")
    fmt.Printf("  - REST validation via ENABLE_REST_VALIDATION=1 (optional)\n")
    fmt.Printf("  - User-data suite requires BINANCE_API_KEY/SECRET on testnet\n")
