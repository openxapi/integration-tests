...
1. SDK locations: WebSocket SDK at ../../../../../../binance-go/ws/umfutures-streams and REST SDK at ../../../../../../binance-go/rest/umfutures. You are only allowed to update the integration tests under the current working directory; you are not allowed to update the SDK code. If you find any SDK issues, please report them first.
