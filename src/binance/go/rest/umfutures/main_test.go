...
func TestMain(m *testing.M) {
	fmt.Println("=== Binance USD-M Futures REST API Integration Tests ===")
	fmt.Println("Running integration tests for Binance USD-M Futures REST API SDK")
